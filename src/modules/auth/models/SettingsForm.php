...
class SettingsForm extends Model
{
        ...
        return [
            ...
            'currentPasswordValidate' => ['current_password', function ($attr) {
                if (!Password::validate($this->$attr, $this->user->password_hash)) {
                    $this->addError($attr, Yii::t('codexten:user', 'Current password is not valid'));
                }
            }],
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'new_password'     => Yii::t('codexten:user', 'New password'),
            'current_password' => Yii::t('codexten:user', 'Current password'),
        ];
    }
    ...
    protected function insecureEmailChange()
    {
        ...
        Yii::$app->session->setFlash('success', Yii::t('codexten:user', 'Your email address has been changed'));
    }
    ...
    protected function defaultEmailChange()
    {
        ...
        Yii::$app->session->setFlash(
            'info',
            Yii::t('codexten:user', 'A confirmation message has been sent to your new email address')
        );
    }
