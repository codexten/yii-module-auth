...
class UserSearch extends Model
{
    ...
    {
        return [
            'fieldsSafe' => [['id', 'username', 'email', 'registration_ip', 'created_at', 'logged_at'], 'safe'],
            'createdDefault' => ['created_at', 'default', 'value' => null],
            'lastloginDefault' => ['logged_at', 'default', 'value' => null],
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'registration_ip' => Yii::t('codexten:user', 'Registration ip'),
        ];
    }
